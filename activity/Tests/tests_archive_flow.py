"""Tests for archiving/unarchiving ratings and reviews"""
...
class ArchiveOnStatusRemovalTests(TestCase):
    """
    Tests that setting reading status to NONE
    archives ratings and reviews.
    """
    def setUp(self):
    ...
    def test_status_none_archives_rating_and_review(self):
        """
        Setting status to NONE deletes status
        and archives ratings and reviews.
        """
...
class UnarchiveOnNewRatingTests(TestCase):
    """
    Tests that posting a new rating unarchives
    any archived rating and creates
    a default status if missing.
    """
    def setUp(self):
    ...
    def test_post_rating_unarchives_and_creates_status(self):
        """Posting a new rating unarchives archived rating"""
